...
const RANK_STYLE = [
  { border: 'var(--accent-glow)', bg: 'var(--accent-dim)',           text: 'var(--accent)', medal: '#1' },
  { border: 'rgba(160,174,192,0.4)', bg: 'rgba(160,174,192,0.07)',   text: '#94a3b8',       medal: '#2' },
  { border: 'rgba(196,150,80,0.4)',  bg: 'rgba(196,150,80,0.07)',    text: '#cd9740',       medal: '#3' },
]
