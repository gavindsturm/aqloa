export interface Lead {
  ...
  eligibilityInputs?: any
  eligibilityRunAt?: string
}
...
export interface TeamMember {
  ...
  chargebacks?: number
  debt?: number
  overrides?: string        // free-text notes on override arrangements
  agentNotes?: string       // admin notes
}
