...
function buildOrgTree(members: TeamMember[]): Map<number, OrgNode> {
  ...
  sorted.forEach(m => {
    ...
    // No role-based fallback — downline is ONLY built from explicit invitedBy relationships
    // An agent who joins without being invited by a specific user has no upline/downline
  })
