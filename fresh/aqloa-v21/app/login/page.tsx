...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', background: '#000' }}>
      ...
      <div className="login-left-panel" style={{ width: 400, flexShrink: 0, background: '#0a0a0a', borderRight: '1px solid rgba(255,255,255,0.08)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '40px 36px' }}>
        <div>
